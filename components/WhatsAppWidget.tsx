  ...
  return (
    <div aria-live="polite" aria-atomic="true">
      ...
      <button
        ...
        style={{ position: 'fixed', right: 28, left: 'auto', bottom: 56, zIndex: 1000, width: 56, height: 56, backgroundColor: '#FFC107', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
      ...
      >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="28" height="28" fill="#111" aria-hidden="true">
      ...
      <style jsx>{`
        ...
        .sonar-ring::after { content: ""; position: absolute; inset: 0; border-radius: 9999px; border: 2px solid rgba(255,193,7,0.65); animation: sonar 10s ease-out infinite; }
      `}</style>
    </div>
  );
}
