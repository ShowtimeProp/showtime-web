...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: "allInOne", title: "All in One (bundle pack)", type: "boolean", initialValue: false, description: "Mark if this solution is a bundle that includes multiple services." }),
